 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "# Create submission file matching sample_submission.csv format\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    if 'Lap_Time_Seconds' not in submission.columns or 'Unique ID' not in submission.columns:\n",
    "        print(\"Error: Required columns missing in submission file\")\n",
    "        return False\n",
...
with open('motogp_final.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=1)
print("Notebook 'motogp_final.ipynb' created successfully!") 